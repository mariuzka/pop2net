...
class Location:
    ...
    def agents(self) -> AgentList:
        ...
        """
        return self.env_p2n.agents_of_location(self)
    ...
    def add_agent(self, agent: _agent.Agent, weight: float | None = None) -> None:
        ...
        """
        self.env_p2n.add_agent_to_location(self, agent=agent, weight=weight)
    ...
    def remove_agent(self, agent: _agent.Agent) -> None:
        ...
        """
        self.env_p2n.remove_agent_from_location(
            location=self,
            agent=agent,
        )
    ...
    def neighbors(self, agent: _agent.Agent) -> AgentList:
        ...
        """
        agents = self.env_p2n.agents_of_location(self)
        agents.remove(agent)
        return agents
    ...
    def get_weight(self, agent: _agent.Agent) -> float:
        ...
        Returns:
            Edge weight.
        """
        return self.env_p2n.get_weight(agent=agent, location=self)
