...
class Location(Object):
    ...
    def group(self, agent) -> object:
        ...
        Allows to create subtypes of this type of location if the location instances are create by
        the population maker. For each unique value of the given agent attribute one subtype of this
    ...
    def contact_weight_average(self, agent1, agent2) -> float:
        """Determine the average amount of time the two agents are at the location
        simultaneously.
        """
