    ...
    def create_locations(
        ...
        for location_cls in location_classes:
            ...
            if location_dummy.melt() is not None:
                ...
                _affiliated_agents = all_melted_agents
            
            else:
            ###
                # get all agents that could be assigned to locations of this class
                _affiliated_agents = [[agent for agent in agents if location_dummy.join(agent)]]
            
            for affiliated_agents in _affiliated_agents:
